...
pub const GLproc = *const fn () callconv(.C) void; // This is the generic type for OpenGL function pointers
...
pub const GL = binding;
pub usingnamespace types;
pub usingnamespace binding; // This makes all public constants and types from binding.zig directly accessible as gl.CONSTANT
...
pub fn ClearColor(red: binding.GLfloat, green: binding.GLfloat, blue: binding.GLfloat, alpha: binding.GLfloat) void {
...
pub fn Clear(mask: binding.GLbitfield) void {
    _glClear.?(mask);
}
...
pub fn loadCoreProfile(get_proc_address_fn: *const fn ([*:0]const u8) ?binding.FunctionPointer) void {
    // This function must be called once after creating the OpenGL context
    // to load all the OpenGL function pointers.

    // Assign the addresses of OpenGL functions to their respective global variables.
    // get_proc_address_fn returns ?*const anyopaque. We must cast it to the
    // specific function pointer type that _gl* variables expect.
    _glClearColor = @as(?*const fn (red: binding.GLfloat, green: binding.GLfloat, blue: binding.GLfloat, alpha: binding.GLfloat) callconv(.C) void, @ptrCast(get_proc_address_fn("glClearColor")));
    _glClear = @as(?*const fn (mask: binding.GLbitfield) callconv(.C) void, @ptrCast(get_proc_address_fn("glClear")));
    _glViewport = @as(?*const fn (x: binding.GLint, y: binding.GLint, width: binding.GLsizei, height: binding.GLsizei) callconv(.C) void, @ptrCast(get_proc_address_fn("glViewport")));
    _glUseProgram = @as(?*const fn (program: binding.GLuint) callconv(.C) void, @ptrCast(get_proc_address_fn("glUseProgram")));
    _glCreateShader = @as(?*const fn (shaderType: binding.GLenum) callconv(.C) binding.GLuint, @ptrCast(get_proc_address_fn("glCreateShader")));
    _glShaderSource = @as(?*const fn (shader: binding.GLuint, count: binding.GLsizei, string: [*c]const [*:0]const u8, length: ?[*]const binding.GLint) callconv(.C) void, @ptrCast(get_proc_address_fn("glShaderSource")));
    _glCompileShader = @as(?*const fn (shader: binding.GLuint) callconv(.C) void, @ptrCast(get_proc_address_fn("glCompileShader")));
    _glGetShaderiv = @as(?*const fn (shader: binding.GLuint, pname: binding.GLenum, params: *binding.GLint) callconv(.C) void, @ptrCast(get_proc_address_fn("glGetShaderiv")));
    _glGetShaderInfoLog = @as(?*const fn (shader: binding.GLuint, maxLength: binding.GLsizei, length: ?*binding.GLsizei, infoLog: [*c]u8) callconv(.C) void, @ptrCast(get_proc_address_fn("glGetShaderInfoLog")));
    _glDeleteShader = @as(?*const fn (shader: binding.GLuint) callconv(.C) void, @ptrCast(get_proc_address_fn("glDeleteShader")));
    _glCreateProgram = @as(?*const fn () callconv(.C) binding.GLuint, @ptrCast(get_proc_address_fn("glCreateProgram")));
    _glAttachShader = @as(?*const fn (program: binding.GLuint, shader: binding.GLuint) callconv(.C) void, @ptrCast(get_proc_address_fn("glAttachShader")));
    _glLinkProgram = @as(?*const fn (program: binding.GLuint) callconv(.C) void, @ptrCast(get_proc_address_fn("glLinkProgram")));
    _glGetProgramiv = @as(?*const fn (program: binding.GLuint, pname: binding.GLenum, params: *binding.GLint) callconv(.C) void, @ptrCast(get_proc_address_fn("glGetProgramiv")));
    _glGetProgramInfoLog = @as(?*const fn (program: binding.GLuint, maxLength: binding.GLsizei, length: ?*binding.GLsizei, infoLog: [*c]u8) callconv(.C) void, @ptrCast(get_proc_address_fn("glGetProgramInfoLog")));
    _glDeleteProgram = @as(?*const fn (program: binding.GLuint) callconv(.C) void, @ptrCast(get_proc_address_fn("glDeleteProgram")));
    _glGenVertexArrays = @as(?*const fn (n: binding.GLsizei, arrays: *binding.GLuint) callconv(.C) void, @ptrCast(get_proc_address_fn("glGenVertexArrays")));
    _glBindVertexArray = @as(?*const fn (array: binding.GLuint) callconv(.C) void, @ptrCast(get_proc_address_fn("glBindVertexArray")));
    _glDeleteVertexArrays = @as(?*const fn (n: binding.GLsizei, arrays: *const binding.GLuint) callconv(.C) void, @ptrCast(get_proc_address_fn("glDeleteVertexArrays")));

    log.debug("OpenGL functions loaded.", .{});
}

// Define ShaderType enum for convenience (if you want to keep it in zgl.zig)
pub const ShaderType = enum(binding.GLenum) {
    vertex = binding.VERTEX_SHADER,
    fragment = binding.FRAGMENT_SHADER,
    geometry = binding.GL_GEOMETRY_SHADER, // Changed to use constant from binding
    tess_control = binding.TESS_CONTROL_SHADER,
    tess_evaluation = binding.TESS_EVALUATION_SHADER,
    compute = binding.COMPUTE_SHADER,
};

var _glClearColor: ?*const fn (red: binding.GLfloat, green: binding.GLfloat, blue: binding.GLfloat, alpha: binding.GLfloat) callconv(.C) void = null;
var _glClear: ?*const fn (mask: binding.GLbitfield) callconv(.C) void = null;
var _glViewport: ?*const fn (x: binding.GLint, y: binding.GLint, width: binding.GLsizei, height: binding.GLsizei) callconv(.C) void = null;
var _glUseProgram: ?*const fn (program: binding.GLuint) callconv(.C) void = null;
var _glCreateShader: ?*const fn (shaderType: binding.GLenum) callconv(.C) binding.GLuint = null;
var _glShaderSource: ?*const fn (shader: binding.GLuint, count: binding.GLsizei, string: [*c]const [*:0]const u8, length: ?[*]const binding.GLint) callconv(.C) void = null;
var _glCompileShader: ?*const fn (shader: binding.GLuint) callconv(.C) void = null;
var _glGetShaderiv: ?*const fn (shader: binding.GLuint, pname: binding.GLenum, params: *binding.GLint) callconv(.C) void = null;
var _glGetShaderInfoLog: ?*const fn (shader: binding.GLuint, maxLength: binding.GLsizei, length: ?*binding.GLsizei, infoLog: [*c]u8) callconv(.C) void = null;
var _glDeleteShader: ?*const fn (shader: binding.GLuint) callconv(.C) void = null;
var _glCreateProgram: ?*const fn () callconv(.C) binding.GLuint = null;
var _glAttachShader: ?*const fn (program: binding.GLuint, shader: binding.GLuint) callconv(.C) void = null;
var _glLinkProgram: ?*const fn (program: binding.GLuint) callconv(.C) void = null;
var _glGetProgramiv: ?*const fn (program: binding.GLuint, pname: binding.GLenum, params: *binding.GLint) callconv(.C) void = null;
var _glGetProgramInfoLog: ?*const fn (program: binding.GLuint, maxLength: binding.GLsizei, length: ?*binding.GLsizei, infoLog: [*c]u8) callconv(.C) void = null;
var _glDeleteProgram: ?*const fn (program: binding.GLuint) callconv(.C) void = null;
var _glGenVertexArrays: ?*const fn (n: binding.GLsizei, arrays: *binding.GLuint) callconv(.C) void = null;
var _glBindVertexArray: ?*const fn (array: binding.GLuint) callconv(.C) void = null;
var _glDeleteVertexArrays: ?*const fn (n: binding.GLsizei, arrays: *const binding.GLuint) callconv(.C) void = null;
...
pub fn getShaderInfoLog(shader: binding.GLuint, maxLength: binding.GLsizei, length: ?*binding.GLsizei, infoLog: [*c]u8) void {
    @as(*const fn (s: binding.GLuint, max_len: binding.GLsizei, len: ?*binding.GLsizei, i_log: [*c]u8) callconv(.C) void, @ptrCast(_glGetShaderInfoLog.?))(shader, maxLength, length, infoLog);
}
...
pub fn getProgramInfoLog(program: binding.GLuint, maxLength: binding.GLsizei, length: ?*binding.GLsizei, infoLog: [*c]u8) void {
    @as(*const fn (p: binding.GLuint, max_len: binding.GLsizei, len: ?*binding.GLsizei, i_log: [*c]u8) callconv(.C) void, @ptrCast(_glGetProgramInfoLog.?))(program, maxLength, length, infoLog);
}
...
pub fn Viewport(x: binding.GLint, y: binding.GLint, width: binding.GLsizei, height: binding.GLsizei) void {
